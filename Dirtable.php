...
$selectquery ="select * from multiusertable where role in('director','superadmin')";
...
<html>
  ...
  <div id="sidebar">
    ...
    <nav class="navbar navbar-default">
      ...
      <div class="container-fluid">
        <h1>Welcome to superadmin panel</h1>
        <button class="btn btn-danger" type="button"><a href="Dirtable.php">Director</a></button>
        <button class="btn btn-danger" type="button"><a href="Memtable.php">Employee</button>
        <button class="btn btn-danger" type="button"><a href="Emptable.php">Member</button>
